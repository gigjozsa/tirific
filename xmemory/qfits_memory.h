...
#define qfits_malloc(s)         malloc(s)
#define qfits_calloc(n,s)       calloc(n,s)
#define qfits_realloc(p,s)      realloc(p,s)
#define qfits_free(p)           free(p)
#define qfits_strdup(s)         strdup(s)
