...
byte * qfits_pixdump_double(double *, int, int) ;
byte * qfits_pixdump_int(int *, int, int) ;
float * qfits_pixin_float(byte *, int, int, double, double) ;
int qfits_pixin_floatbuf(byte *, int, int, double, double, float *) ;
byte * qfits_pixdump_float(float *, int, int) ;
