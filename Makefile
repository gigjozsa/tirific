...
$(SRC)tirific.o: $(SRC)tirific.c $(SRC)version.h $(LOCINCDIR)engalmod.h $(LOCINCDIR)ftstab.h $(LOCINCDIR)maths.h $(LOCINCDIR)cubarithm.h $(MATHDIR)math.h $(FFTWDIR)fftw3.h $(GFTDIR)gft.h $(DIR)settings
	@echo '###########################'
...
$(SRC)version.o: $(SRC)version.c $(SRC)version.h
	@echo '###################'
	@echo '# starting version.o #'
	@echo '###################'
	$(CC) $(CFLAGS) -c -o $@ $< $(LOCINC)
	@echo '###################'
	@echo '# version.o finished #'
	@echo '###################'
